...
<section class="pwr-page-hero">
  <div class="pwr-container">
    <span class="pwr-eyebrow-tag">Join Smile Source</span>
...
<section class="pwr-sub-section pwr-sub-section--alt">
  <div class="pwr-container">
    <div class="pwr-sub-head"><span class="pwr-sub-eyebrow">What's Included</span><h2 class="pwr-sub-title">Everything You Get as a Smile Source Member.</h2></div>
    <div class="pwr-sub-grid-4">
      <div class="pwr-sub-stat"><div class="pwr-sub-stat__num">40%</div><div class="pwr-sub-stat__label">Off dental supplies from elite vendor partners</div></div>
      <div class="pwr-sub-stat"><div class="pwr-sub-stat__num">$6M+</div><div class="pwr-sub-stat__label">In member rebates earned annually across the network</div></div>
      ...
      <div class="pwr-sub-stat"><div class="pwr-sub-stat__num">100%</div><div class="pwr-sub-stat__label">Ownership retained — we are not a DSO, never will be</div></div>
    </div>
  </div>
</section>
...
<section class="pwr-sub-section">
  <div class="pwr-container">
    <div class="pwr-sub-grid-2" style="gap:80px;align-items:start;">
      ...
      <div>
        <span class="pwr-sub-eyebrow">Start Your Application</span>
        <h2 class="pwr-sub-title" style="margin-bottom:8px;">Tell us about your practice.</h2>
        <p class="pwr-sub-desc" style="margin-bottom:28px;">A Member Success Specialist will reach out within one business day to walk you through the process.</p>
        <form action="#" method="POST">
          ...
          <button type="submit" class="pwr-btn pwr-btn--primary pwr-btn--large" style="width:100%;justify-content:center;">Submit Application</button>
      ...
      <div>
        <span class="pwr-sub-eyebrow">Member Benefits</span>
        <h2 class="pwr-sub-title" style="margin-bottom:20px;">What You'll Access From Day One.</h2>
        <ul class="pwr-sub-check" style="gap:14px;">
          <li class="pwr-sub-check-item"><i class="fas fa-check-circle"></i> Up to 40% off dental supplies, 30% off lab work</li>
          <li class="pwr-sub-check-item"><i class="fas fa-check-circle"></i> Up to 45% savings with dental manufacturers</li>
          <li class="pwr-sub-check-item"><i class="fas fa-check-circle"></i> $6M+ in member rebates earned annually</li>
          <li class="pwr-sub-check-item"><i class="fas fa-check-circle"></i> Dedicated Member Success Specialist</li>
          <li class="pwr-sub-check-item"><i class="fas fa-check-circle"></i> Group health insurance &amp; employee benefits</li>
          <li class="pwr-sub-check-item"><i class="fas fa-check-circle"></i> Staff recruiting &amp; payroll support</li>
          <li class="pwr-sub-check-item"><i class="fas fa-check-circle"></i> In-house dental plan design</li>
          <li class="pwr-sub-check-item"><i class="fas fa-check-circle"></i> Patient financing solutions</li>
          <li class="pwr-sub-check-item"><i class="fas fa-check-circle"></i> Marketing &amp; digital presence support</li>
          <li class="pwr-sub-check-item"><i class="fas fa-check-circle"></i> Strategic practice consulting</li>
          <li class="pwr-sub-check-item"><i class="fas fa-check-circle"></i> Hundreds of CE courses annually</li>
          <li class="pwr-sub-check-item"><i class="fas fa-check-circle"></i> Access to The Exchange annual conference</li>
          <li class="pwr-sub-check-item"><i class="fas fa-check-circle"></i> Local &amp; national peer networking events</li>
          <li class="pwr-sub-check-item"><i class="fas fa-check-circle"></i> 100% ownership — always</li>
        </ul>
        <div class="pwr-sub-testimonial" style="margin-top:32px;">
...
<section class="pwr-sub-section pwr-sub-section--alt">
  <div class="pwr-container">
    ...
    <div style="display:flex;flex-wrap:wrap;justify-content:center;align-items:center;gap:32px;filter:grayscale(1);opacity:.5;">
...
<section class="pwr-sub-cta">
  <div class="pwr-container">
    ...
    <div class="pwr-sub-cta-row">
      <a href="/v3/lets-talk" class="pwr-btn pwr-btn--white pwr-btn--large">Let's Talk First</a>
    </div>
  </div>
</section>
@endsection
