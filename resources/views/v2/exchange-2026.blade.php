...
<section class="sr-page-hero">
  <div class="sr-container">
    ...
    <div class="sr-page-hero-actions">
      <a href="/v2/lets-talk" class="sr-btn sr-btn-primary">Register Now</a>
      <a href="/v2/education" class="sr-btn sr-btn-outline-white">Learn About CE</a>
    </div>
  </div>
</section>
...
<section class="sr-section sr-section--alt">
  <div class="sr-container">
    <div class="sr-grid-4">
      <div class="sr-stat-card"><div class="sr-stat-card__num">17</div><div class="sr-stat-card__label">CE credits available for you and your team</div></div>
...
<section class="sr-section">
  <div class="sr-container">
    ...
    <div class="sr-grid-3">
      <div class="sr-card"><div class="sr-card__icon"><i class="fas fa-graduation-cap"></i></div><h3>World-Class CE</h3><p>Cutting-edge courses designed for dentists, hygienists, dental assistants, and front office staff. Earn up to 17 CE credits across clinical, technology, and business tracks.</p></div>
      <div class="sr-card"><div class="sr-card__icon"><i class="fas fa-tags"></i></div><h3>Exclusive Vendor Deals</h3><p>Access The Exchange floor with 75+ elite vendors offering exclusive conference pricing and product demonstrations you won't find anywhere else.</p></div>
      <div class="sr-card"><div class="sr-card__icon"><i class="fas fa-users"></i></div><h3>Peer Networking</h3><p>Connect with 1,100+ independent dentists from across the country — practitioners who understand your journey and are invested in your success.</p></div>
      <div class="sr-card"><div class="sr-card__icon"><i class="fas fa-lightbulb"></i></div><h3>Innovation Showcase</h3><p>Discover the latest dental technology, digital workflows, and practice management tools — curated and vetted by Smile Source for independent practices.</p></div>
      <div class="sr-card"><div class="sr-card__icon"><i class="fas fa-handshake"></i></div><h3>Strategic Meetings</h3><p>Scheduled one-on-ones with vendor partners and Smile Source success specialists to maximize your ROI from every aspect of your membership.</p></div>
      <div class="sr-card"><div class="sr-card__icon"><i class="fas fa-map-marker-alt"></i></div><h3>San Antonio, TX</h3><p>Experience the energy of The River Walk and the warmth of Texas hospitality — a destination that adds to the magic of The Exchange every year.</p></div>
    </div>
  </div>
</section>
...
<section class="sr-event-box">
  <div class="sr-container">
    <div class="sr-grid-2" style="align-items:center;">
      <div>
        <span class="sr-eyebrow">Event Details</span>
        ...
        <ul class="sr-check-list" style="margin:16px 0;">
          <li class="sr-check-item"><i class="fas fa-check-circle"></i> Members-only early-bird pricing available</li>
          <li class="sr-check-item"><i class="fas fa-check-circle"></i> Team registrations welcome</li>
          <li class="sr-check-item"><i class="fas fa-check-circle"></i> Earn up to 17 CE credits</li>
          <li class="sr-check-item"><i class="fas fa-check-circle"></i> Access exclusive vendor deals on the floor</li>
        </ul>
        <a href="/v2/lets-talk" class="sr-btn sr-btn-primary">Register Now</a>
      </div>
...
<section class="sr-cta-band">
  <div class="sr-container">
    ...
    <div class="sr-cta-actions">
      <a href="/v2/lets-talk" class="sr-btn sr-btn-white">Register Now</a>
      <a href="/v2/join" class="sr-btn sr-btn-outline-white">Join Smile Source</a>
    </div>
  </div>
</section>
@endsection
