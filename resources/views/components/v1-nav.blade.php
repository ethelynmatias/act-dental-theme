<nav class="site-nav">
  ...
  {{-- ===== MAIN NAV ===== --}}
  <div class="v1-nav-main">
    <div class="v1-nav-inner">

      {{-- Logo --}}
      <a href="/v1/home" class="v1-nav-logo">
        <img src="https://23372339.fs1.hubspotusercontent-na1.net/hub/23372339/hubfs/Branding/Logos%20(2024)/Smile%20Source%202024%20Logo.png?width=300&height=47"
             alt="Smile Source" height="38" style="height:38px;width:auto;">
      </a>

      {{-- Desktop Menu --}}
      <ul class="v1-nav-menu">
        ...
        <li class="v1-nav-item">
          ...
          <div class="v1-mega">
            <div class="v1-mega-inner">
              ...
              <div class="v1-mega-promo">
                <div>
                  <div class="v1-mega-promo-label">Over $1 Billion in Purchasing Power</div>
                  <h4>Deep discounts that go straight to your bottom line.</h4>
                  <p>Smile Source has vetted and negotiated rates with the industry's largest vendors to save on dental technology, supplies, labs, and services.</p>
                </div>
                <a href="/v1/membership/savings" class="v1-mega-promo-cta">Explore benefits →</a>
              </div>
            </div>
          </div>
        </li>
      ...
      {{-- Hamburger --}}
      <button class="v1-hamburger" id="v1NavHam" aria-label="Toggle menu">
        <span></span>
        <span></span>
        <span></span>
      </button>
  ...
  {{-- ===== MOBILE MENU ===== --}}
  <ul class="v1-mobile-nav" id="v1MobileNav">

    <li>
      <button class="v1-mobile-toggle" data-target="mob-why">
        Why Smile Source
        <svg viewBox="0 0 10 6" xmlns="http://www.w3.org/2000/svg"><path d="M1 1l4 4 4-4" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>
      </button>
    ...
    <li>
      <button class="v1-mobile-toggle" data-target="mob-membership">
        Membership Benefits
        <svg viewBox="0 0 10 6" xmlns="http://www.w3.org/2000/svg"><path d="M1 1l4 4 4-4" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>
      </button>
