...
<section class="v4-page-hero">
  <div class="container">
    <div class="v4-overline">Join Smile Source</div>
...
<section class="v4-sub-section v4-sub-section--alt">
  <div class="container">
    <div class="v4-sub-head"><div class="v4-overline">What's Included</div><h2>Everything You Get as a Smile Source Member.</h2></div>
    <div class="v4-sub-grid-4">
      <div class="v4-sub-stat"><div class="v4-sub-stat__num">40%</div><div class="v4-sub-stat__label">Off dental supplies from elite vendor partners</div></div>
      <div class="v4-sub-stat"><div class="v4-sub-stat__num">$6M+</div><div class="v4-sub-stat__label">In member rebates earned annually across the network</div></div>
      ...
      <div class="v4-sub-stat"><div class="v4-sub-stat__num">100%</div><div class="v4-sub-stat__label">Ownership retained — we are not a DSO, never will be</div></div>
    </div>
  </div>
</section>
...
<section class="v4-sub-section">
  <div class="container">
    <div class="v4-sub-grid-2" style="gap:80px;align-items:start;">
      ...
      <div>
        <div class="v4-overline">Start Your Application</div>
        ...
        <form action="#" method="POST">
          ...
          <button type="submit" class="btn-accent btn-cta" style="width:100%;justify-content:center;">Submit Application</button>
          <p style="font-size:12px;text-align:center;margin-top:12px;opacity:.5;">No commitment required. A member of our team will follow up personally.</p>
        </form>
      </div>

      <div>
        <div class="v4-overline">Member Benefits</div>
        <h2 style="margin-bottom:20px;">What You'll Access From Day One.</h2>
        <ul class="v4-sub-check" style="gap:14px;">
          <li class="v4-sub-check-item"><i class="fas fa-check-circle"></i> Up to 40% off dental supplies, 30% off lab work</li>
          <li class="v4-sub-check-item"><i class="fas fa-check-circle"></i> Up to 45% savings with dental manufacturers</li>
          <li class="v4-sub-check-item"><i class="fas fa-check-circle"></i> $6M+ in member rebates earned annually</li>
          <li class="v4-sub-check-item"><i class="fas fa-check-circle"></i> Dedicated Member Success Specialist</li>
          <li class="v4-sub-check-item"><i class="fas fa-check-circle"></i> Group health insurance &amp; employee benefits</li>
          <li class="v4-sub-check-item"><i class="fas fa-check-circle"></i> Staff recruiting &amp; payroll support</li>
          <li class="v4-sub-check-item"><i class="fas fa-check-circle"></i> In-house dental plan design</li>
          <li class="v4-sub-check-item"><i class="fas fa-check-circle"></i> Patient financing solutions</li>
          <li class="v4-sub-check-item"><i class="fas fa-check-circle"></i> Marketing &amp; digital presence support</li>
          <li class="v4-sub-check-item"><i class="fas fa-check-circle"></i> Strategic practice consulting</li>
          <li class="v4-sub-check-item"><i class="fas fa-check-circle"></i> Hundreds of CE courses annually</li>
          <li class="v4-sub-check-item"><i class="fas fa-check-circle"></i> Access to The Exchange annual conference</li>
          <li class="v4-sub-check-item"><i class="fas fa-check-circle"></i> Local &amp; national peer networking events</li>
          <li class="v4-sub-check-item"><i class="fas fa-check-circle"></i> 100% ownership — always</li>
        </ul>
        <div class="v4-sub-testimonial" style="margin-top:32px;">
          ...
          <div class="v4-sub-testimonial-author">
            <img src="{{ asset('images/v1/dentist-1.png') }}" alt="Jeff Henneberg, DDS" class="v4-avatar-img">
...
<section class="v4-sub-section v4-sub-section--alt">
  <div class="container">
    <p style="text-align:center;font-size:14px;font-weight:600;letter-spacing:.08em;text-transform:uppercase;opacity:.5;margin-bottom:32px;">75+ Elite Vendor Partners — Vetted &amp; Negotiated for Members</p>
...
<section class="v4-sub-cta">
  <div class="container">
    ...
    <div class="v4-sub-cta-row">
      <a href="/v4/lets-talk" class="btn-accent btn-cta">Let's Talk First</a>
    </div>
  </div>
</section>
@endsection
