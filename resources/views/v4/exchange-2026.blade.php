...
<section class="cp-ex-hero">
  ...
  <div class="container cp-ex-hero__inner">
    ...
    <div class="cp-ex-hero__cta">
      <a href="{{ $vp }}/lets-talk" class="btn-accent btn-cta">Register Now</a>
      <a href="{{ $vp }}/membership/education" class="btn-outline-light btn-cta">Learn About CE</a>
    </div>
  </div>
</section>
...
<section class="v4-sub-section v4-sub-section--alt">
  <div class="container">
    <div class="v4-sub-grid-4">
      <div class="v4-sub-stat"><div class="v4-sub-stat__num">40+</div><div class="v4-sub-stat__label">CE courses to choose from</div></div>
...
<section class="v4-sub-section">
  <div class="container">
    <div class="v4-sub-head">
      <div class="v4-overline">All-Inclusive Experience</div>
...
<section class="v4-sub-section v4-sub-section--alt">
  <div class="container">
    <div class="v4-sub-head">
      <div class="v4-overline">Featured Speakers</div>
...
<section class="v4-sub-section">
  <div class="container">
    <div class="v4-sub-head">
      <div class="v4-overline">What's Happening</div>
...
<section class="v4-sub-section v4-sub-section--alt">
  <div class="container">
    <div class="v4-sub-head">
      <div class="v4-overline">From Past Attendees</div>
...
<section class="cp-ex-venue">
  ...
  <div class="cp-ex-venue__info-col">
    <div class="cp-ex-venue__info">
      ...
      <a href="{{ $vp }}/lets-talk" class="btn-accent btn-cta" style="margin-top:8px;">Register Now</a>
    </div>
  </div>
</section>
...
<section class="v4-sub-cta">
  <div class="container">
    ...
    <div class="v4-sub-cta-row">
      <a href="{{ $vp }}/lets-talk" class="btn-accent btn-cta">Register Now</a>
      <a href="{{ $vp }}/join" class="btn-outline-light btn-cta">Join Smile Source</a>
    </div>
  </div>
</section>
